      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          <p className="text-center text-gray-600 mb-10 max-w-4xl mx-auto">
            Whether you prefer to gaze out at lush coastal greenery or fall asleep to the soothing rhythm of the ocean, you'll find sanctuary in every one of our rooms.
          </p>
            ...
            {rooms.map((room, index) => (
              <div key={index} className="border rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform duration-300 hover:scale-105">
                <div className="relative">
                  ...
                  <div className="absolute bottom-0 left-0 bg-teal-800 bg-opacity-80 text-white px-4 py-2 text-sm font-semibold">
                    {room.title}
                  </div>
                </div>
                <div className="p-4">
