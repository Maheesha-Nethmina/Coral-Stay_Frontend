...
const Booking = () => {
  ...
  const bookingDetails = {
    selection: 'Sheet Number 11,12,13,14',
    date: '12/07/2025',
    pricePerSheet: 30,
    serviceFee: 0,
    discount: 20,
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">{bookingDetails.selection}</p>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold">${bookingDetails.pricePerSheet}</span>
              </div>
              
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Service fee:</span>
                <span className="font-semibold">${bookingDetails.serviceFee}</span>
              </div>
              ...
              <div className="border-t pt-3">
                <div className="flex items-center justify-between text-lg font-bold">
                  ...
                  <span className="text-teal-600">${bookingDetails.fullAmount}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-8">
          <p className="text-sm text-amber-800">
            ...
            <a 
              href="#" 
              className="text-amber-900 underline hover:text-amber-700 transition-colors font-medium"
            >
              Terms of Service
            </a>{' '}
