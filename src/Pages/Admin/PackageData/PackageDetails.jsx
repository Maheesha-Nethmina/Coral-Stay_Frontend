      ...
      <div className="flex flex-1 bg-[#eaf4f6] mt-10">
        ...
        <main className="flex-1 p-6 mt-10 bg-[#eaf4f6]">
          ...
          <div className="overflow-x-auto w-full mb-4">
            <div className="grid grid-cols-[100px_200px_150px_100px_80px_80px_120px_100px_100px] gap-3 bg-gray-100 text-gray-700 uppercase text-sm font-semibold p-2 rounded">
              <div>Image</div>
              <div>Title</div>
              <div>Description</div>
              <div>Includes</div>
